...
public interface NoticeRepository extends JpaRepository<NoticeEntity, Long> {
  ...
  @Query("SELECT n FROM NoticeEntity n WHERE n.writer.memberId = :writerId")
  ...
  Page<NoticeEntity> findByPostedAtBetween(@Param("startDate") LocalDateTime startDate, @Param("endDate") LocalDateTime endDate, Pageable pageable);
}
