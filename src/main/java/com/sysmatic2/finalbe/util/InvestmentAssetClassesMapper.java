...
public class InvestmentAssetClassesMapper {
    ...
    public InvestmentAssetClassesDto toDto(InvestmentAssetClassesEntity iacEntity) {
    ...
    public InvestmentAssetClassesEntity toEntity(InvestmentAssetClassesDto iacDto) {
