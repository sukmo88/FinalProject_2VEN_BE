...
//    @MapsId("strategyId")
//    private StrategyEntity strategyId; // 전략 연관관계
//
//    @Id
//    @ManyToOne
//    @JoinColumn(name = "daily_strategic_statistics_id", referencedColumnName = "daily_strategic_statistics_id", nullable = false)
//    @MapsId("dailyStrategicStatisticsId")
//    private DailyStrategicStatisticsEntity dailyStrategicStatisticsId; // 일간 통계 연관관계
//
//    @Id
