...
class FAQServiceTest {
    ...
    public void whenCreateFAQ_thenFindAllForAdmin(){
        ...
        // when
        List<?> faqList = faqService.getAllFAQs("ADMIN");

        //then
        assertEquals(10, faqList.size());
        assertEquals("What is FAQ?1", ((AdminFAQDto) faqList.get(0)).getQuestion() );
        assertEquals("This is FAQ1", ((AdminFAQDto) faqList.get(0)).getAnswer());
    }
    ...
    public void whenCreateFAQ_thenFindAllForUser(){
        ...
        // when
        List<?> faqList = faqService.getAllFAQs("USER");

        //then
        assertEquals(10, faqList.size());
        assertEquals("What is FAQ?1", ((UserFAQDto) faqList.get(0)).getQuestion() );
        assertEquals("This is FAQ1", ((UserFAQDto) faqList.get(0)).getAnswer());
    }
